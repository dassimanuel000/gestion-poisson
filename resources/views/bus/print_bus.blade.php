                        ...
                        <div class="col-md-12">
                            <p class="text-center">
                                <table class="table-responsive table" border="0,6" class="table-imprimer">
                                    <thead>
                                        <tr>
                                            <th class="text-center col-md-12" style="background-color:dodgerblue;color:white;width:44440px;" colspan="5">Listes des eleves prenant le bus</th>
                                        </tr>
                                        <tr>
                                            <td>N*</td>
        ...
        <div class="col-md-4">
            <div id="putain">
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <a class="btn btn-danger" href="/list_bus">
                            BACK TO HOME
                        </a>
                    </div>
                </div>
