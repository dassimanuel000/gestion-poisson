                    ...
                    <section class="contain-imprimer">
                        ...
                        <div class="col-md-12">
                                <div class="float-left col-md-6">
                                    <li>Noms & Pr&eacute;noms : <b style="text-transform: uppercase;">{{ $item->name_eleve }}   {{ $item->prenom_eleve }}</b> </li>
                                        ...
                                        <th style="">
                                            ...
                                            @if ($select)
                                                @foreach ($select as $select_item)
                                                    {{ $select_item->motif  }} : {{ number_format($select_item->montant)  }}
                                                    <small>Fait le: {{ date('d F Y H:i:s', strtotime($select_item->updated_at)) }}</small>
                                                    <br>
                                                @endforeach
                                            @else
                                                -
                                ...
                                <li>
                                    ...
                                    @if ($pension)
                                        @foreach ($pension as $pension_item)
                                            @php
                                                $t = ($item->inscription)+($item->tranche1)+($item->tranche2) - ($pension_item->pension);
                                                if ($t > 0 ) {
                                                    echo number_format(0.000);
                                                } else {
        ...
        <div class="col-md-4">
            <div id="putain">
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <a class="btn btn-danger" href="/search_eleve">
                            BACK TO HOME
                        </a>
                    </div>
                </div>
