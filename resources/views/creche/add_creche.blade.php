								...
								<div class="card-body">
									<div class="row">
										<div class="col-md-12 col-lg-12">
                                            <form action="{{ route('form_add_creche') }}" method="POST" enctype="multipart/form-data" class="form-horizontal" role="form">
                                                {{ csrf_field() }}
                                                <div class="form-group">
                                                    <label for="email2">Nom de l'Enfant</label>
                                                    <input type="text" class="form-control" id="name_eleve" name="name_eleve" placeholder="Nom de l'Enfant" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="prenom_eleve">Prenom de l'Enfant</label>
                                                    <input type="text" class="form-control" id="prenom_eleve" name="prenom_eleve" placeholder="Prenom de l'Enfant" required>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="adresse" name="adresse" placeholder="Adresse de l'Enfant" required>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="lieu_naissance" name="lieu_naissance" placeholder="Lieu de naissance de l'Enfant">
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" id="paiement" name="paiement" placeholder="Montant verse">
                                                </div>
