				...
				<div class="page-inner mt--5">
					<div class="row mt--2">
								...
								<div class="card-body">
									<div class="row">
										<div class="col-md-12 col-lg-12">
                                            ...
                                            <form action="{{ route('form_add_classe') }}" method="GET" enctype="multipart/form-data" class="form-horizontal" role="form">
                                                <div class="form-group">
                                                    <label for="name_classe">Nom de la classe</label>
                                                    <input type="name_classe" class="form-control" id="name_classe" name="name_classe" placeholder="Ex : Cours Prepatoire" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="initial_classe">Initial de la classe</label>
                                                    <input type="text" class="form-control" id="initial_classe" name="initial_classe" placeholder="Ex : CP" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="pension">La pension totale de la classe</label>
                                                    <input type="number" class="form-control" id="pension" name="pension" placeholder="Ex : 70 000" required>
                                                </div>
						...
						<div class="col-md-4">
							<div class="card full-height shadow">
								<div class="card-body">
									<div class="card-title">Ajouter Une Classe</div>
